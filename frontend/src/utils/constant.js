...
if (mode === "production") {
  USER_API_END_POINT = "https://job-portal-26m0.onrender.com/api/v1/user";
  JOB_API_END_POINT = "https://job-portal-26m0.onrender.com/api/v1/job";
  APPLICATION_API_END_POINT =
    "https://job-portal-26m0.onrender.com/api/v1/application";
  COMPANY_API_END_POINT = "https://job-portal-26m0.onrender.com/api/v1/company";
} else {
